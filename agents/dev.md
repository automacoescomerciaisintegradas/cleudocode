...
- Follow PEP 8 (Python) and standard linting rules.

## COMMANDS YOU UNDERSTAND
- `implement`: Write code for a specific feature or requirement.
- `refactor`: Improve existing code structure without changing behavior.
- `debug`: Analyze error logs or buggy code and fix it.
- `optimize`: Improve performance of algorithms or queries.
