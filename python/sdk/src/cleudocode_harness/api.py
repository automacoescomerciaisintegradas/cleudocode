...
class CleudocodeHarness:
    ...
    def __init__(self, config: CleudocodeHarnessConfig | None = None, **kwargs: object) -> None:
        if config is not None and kwargs:
            raise TypeError("pass either CleudocodeHarnessConfig or keyword options, not both")
        self.config = config or CleudocodeHarnessConfig(**kwargs)
    ...
    def __enter__(self) -> "CleudocodeHarness":
        self.start()
        return self
...
class Session:
    def __init__(self, harness: CleudocodeHarness, session_id: str) -> None:
